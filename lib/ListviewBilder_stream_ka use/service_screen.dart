...
Future<String> parentData(String name,String email, int phone,String gender)async{
  var doc=await FirebaseFirestore.instance.collection("parentsAddData").add({
    "name":name,
    "email":email,
    "phone":phone,
    "gender":gender,
...
childtData( String name, String email,int phone,String gender,String parentId)async{
